...
* 설명: 꿀벌이 동료 일벌들에게 꽃의 위치를 알려주기 위해 8자 춤을 춘다는 사실을 조사하여 아두이노 로봇을 통해 최대한 유사하게 구현하려고 노력함.
* 소감:
  ...
  4) 차우진 : 팀장으로서 제가 빠른 의사결정을 위해 혼자서 결정을 해야되는지, 아니면 모든 구성원들의 의견을 종합해야 하는지 이 둘 중 사이에서 매 순간마다 고민하는 과정을 거쳤습니다. 이때까지 팀프로젝트의 팀장을 도맡아 해오면서 모든 것을 혼자 짊어지는 것이 가장 편했고 그러면 다른 사람의 인정을 받을 수 있을 것이라고 생각했던 것 같습니다. 하지만 제가 틀렸던 것 같습니다. 리더는 팀원들보다 능력이 뛰어난 사람이 아니라 각자의 고유한 능력에 맞게 일을 적절하게 분배하는 사람이라는 것을 이번 기회를 통해 배울 수 있었습니다.
